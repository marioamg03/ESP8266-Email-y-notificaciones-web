...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "Yml0c2FuZHBpeGVsczFAZ21haWwuY29tCg==";  //Correo Electronico y Clave en base 64Bits
        const char* EMAILBASE64_PASSWORD = "Qml0cyZQaXhlbHMuMjAxNw==";
        const char* FROM = "bitsandpixels1@gmail.com";                          //Remitente del correo electronica
